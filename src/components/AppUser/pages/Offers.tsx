...
export default function UserOffers() {
  ...
  const openCreate = () => { setEditing(null); setForm({ title: '', description: '', discount: '', validFrom: new Date().toISOString().split('T')[0], validTo: new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toISOString().split('T')[0], status: 'active', targetRole: 'user', bonusPoints: 10 }); setShowForm(true); };
